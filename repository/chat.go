...
func (q *Queries) CreateChat(ctx context.Context, chatID []byte) (domain.ChatRoom, error)  {
...
func (q *Queries) GetChat(ctx context.Context, users []domain.User) (domain.ChatRoom, error)  {
...
func (q *Queries) GetMessages(ctx context.Context, chatID []byte) ([]domain.Message, error)  {
...
func (q *Queries) SendMessage(ctx context.Context, message domain.Message) (error) {
