...
func (p *postRepo) GetPost(ctx context.Context, postID crypto.UUID) (*domain.PostInfo, error) {
...
func (p *postRepo) GetPosts(ctx context.Context, limit, offset int) ([]*domain.PostInfo, error) {
